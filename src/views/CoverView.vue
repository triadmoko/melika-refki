    ...
    <center>
      <div class="z-10 max-w-sm w-3/4 flex justify-center my-40 lg:max-w-full lg:flex ">
        <div class="max-w-sm rounded overflow-hidden shadow-lg bg-gray-200">
          ...
          <div class="px-6 py-4">
            <div class="font-bold  text-xl mb-2">Refki & Melika</div>
          ...
          <div class="px-6 pt-4 pb-2 flex justify-center">
            <RouterLink to="/undang"
              class="z-20 inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
...
section {
  ...
  width: 100%;
  position: absolute;
  background: radial-gradient(rgb(235, 233, 233), rgb(170, 106, 106));
}
