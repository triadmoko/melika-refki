      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  rounded-md">
        <div class="text-center ">
          <p class="mt-4 max-w-2xl text-gray-500 lg:mx-auto">
            "Dan di antara tanda-tanda kekuasaan-Nya ialah dia menciptakan isteri-isteri dari jenismu sendiri, supaya
            kamu cenderung dan merasa tentram kepadanya, dan jadikan-Nya diantaramu rasa kasih dan sayang. Sesungguhnya
    ...
    <div class="bg-white py-14 bg-gradient-to-r from-cyan-500 to-blue-500">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  rounded-md">
        <div class="text-center ">
          <p class="mt-4 max-w-2xl text-gray-500 lg:mx-auto">
            <img width="600"
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Basmala.svg/640px-Basmala.svg.png" alt="">
            ٱلسَّلَامُ عَلَيْكُمْ وَرَحْمَةُ ٱللَّٰهِ وَبَرَكَاتُهُ
            <br> Seraya terngadah jemari dalam harapan kasih illahi, dengan memohon rahmat dan ridho Allah SWT
            Perkenakan kami menikahkan putra-putri kami :
          </p>
          <br>
...
.bgaja {
  background-image: url('https://nikahyo.com/image/wedding/background/bg-safitri-helmi.jpg');
  width: 100%;
  height: 100%;
  left: 0;
  top: 0;
